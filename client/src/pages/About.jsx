  ...
  return (
    <>
              ...
              <div class="flip-card-inner">
                ...
                <div class="flip-card-back">
                  <div class="text">
                    <h3>5</h3>
                    <p>
                      환경 보호를 위해 다른 이들과 일상 속에서 작은 것들을
                      실천해나갑시다.
                    </p>
                  </div>
                </div>
              ...
              <div class="flip-card-inner">
                ...
                <div class="flip-card-back">
                  <div class="text">
                    <h3>6</h3>
                    <p>
                      3차원 가상공간에서 환경에 대한 인식을 높이고, 현실세계에서
                      이에 대한 인식이 행동으로 꼭 이루어지기를 바랍니다!
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="banner-area">
        ...
        <br></br>
        <h3>
          이 사이트는 3차원 가상공간에서 환경에 대한 인식을 높이고, 관련 행동을
          촉구하기 위해 만들어졌습니다. <br></br>
          메타버스 게임을 통해 환경과 가까워질 수 있는 계기를 제공합니다. 이를
          통해 여러분들이 환경에 대해서 다시 한 번 생각해볼 수 있을 것이라고
          기대합니다.{' '}
        </h3>
      </section>
      ...
      <section className="services-area" id="services">
        ...
        <ul className="services-content">
          ...
          <li>
            <h4>2단계</h4>
            <p>사용자는 w, a, s, d키를 눌러 캐릭터를 이동시킬 수 있습니다.</p>
          </li>
          <li>
            <h4>3단계</h4>
            <p>여러 사진의 큐브를 클릭하여 우리 지구에 대해 알아보세요!</p>
          </li>
        </ul>
      </section>
    </>
